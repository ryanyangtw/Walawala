...
! function (t, e, a, i) {
  ...
  s.prototype = {
    reload: function() {
      ...
      this.playlistSrc = this.getPlaylist();
      this.playlist = this.playlistSrc.slice(0)
    },
    init: function() {
      // console.log(this.playListObj.get());
      var e = this;
    ...
    updatePrevNextButtons: function() {
      this.getIndex() > 0 ? (this.buttonPrevious = !0, this.prevBut.removeClass("disabled")) : (this.buttonPrevious = !1, this.prevBut.addClass("disabled")), this.getIndex() < this.listLen - 1 ? (this.buttonNext = !0, this.nextBut.removeClass("disabled")) : (this.buttonNext = !0, this._player.data("audIndex",-1))
    },
    attachEvents: function() {
      ...
      this.shuffBut.on("click", function() {
        ...
        return e.buttonNext ? (index = e.getIndex() + 1, void e.source(index, !0)) : !0
        ...
        if (nextIndex = e.getIndex() + 1, e.seekTrack.css("width", "0%"), e.listLen != nextIndex) e.source(nextIndex, !0);
         ...
         this._player.data("audIndex",-1);
        }
      }), t(".progress").on("click", function(a) {
        a.preventDefault();
        var i = t(this).width();
          // s = (a.clientX - 635) / i * 100;
          var w = $(window).width()-350;
          s = (a.clientX - ((w)/2 + 50)) / i * 100;
