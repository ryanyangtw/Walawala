Rails.application.routes.draw do
  ...
  post "episodes/more_customize_episodes", to: "episodes#more_customize_episodes", as: :more_customize_episodes
  post "episodes/:episode_id/tags/:tag_id/vote", to: "votes#create", as: :votes
  delete "episodes/:episode_id/tags/:tag_id/cancel_vote", to: "votes#destroy", as: :cancel_vote
